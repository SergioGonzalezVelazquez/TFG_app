...
public class EventDetectionService extends Service {
    ...
    boolean isStopCheckInProgress = false;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent!=null && intent.getBooleanExtra
            ...
            startEventProcessing();
                ...
                ("isStopCheckInProgress")) {
            boolean value = intent.getBooleanExtra("isStopCheckInProgress", false);
            if(value) {
                mScheduledExecutorService.submit(mEventProcessorThread);
                isStopCheckInProgress = value;
            }
            sendMessage("Recibido intent avisando de potencial evento de parada");
        }
        else {
    ...
    public class EventProcessorThread implements Runnable {
        ...
        public void run() {
            ...
            if(!isStopCheckInProgress) {
                ...
                sendMessage("No haces nada porque estamos en progreso de confirmación parada");
            }
