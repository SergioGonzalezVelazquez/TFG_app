...
public class MainActivity extends FlutterActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    methodChannelStartService = new MethodChannel(getFlutterView(), EMOVI_CHANNEL_MAC_ADDRESS);
    methodChannelStartService.setMethodCallHandler(new MethodChannel.MethodCallHandler() {
      ...
      public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
        ...
        Log.w(TAG, "data: " +  String.valueOf(methodCall.method));

        intentForEMOVI.putExtra("macAddress", methodCall.method);
