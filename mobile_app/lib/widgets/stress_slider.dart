...
class _StressSliderState extends State<StressSlider> {
  ...
  String getImage() {
    String image = '';
    if (_sliderValue < 5) {
      image = "assets/images/stress/pain_0.png";
    } else if (_sliderValue < 10.0) {
      image = "assets/images/stress/pain_1.png";
    } else if (_sliderValue >= 10 && _sliderValue < 20) {
      image = "assets/images/stress/pain_2.png";
    } else if (_sliderValue >= 20 && _sliderValue < 30) {
      image = "assets/images/stress/pain_3.png";
    } else if (_sliderValue >= 30 && _sliderValue < 40) {
      image = "assets/images/stress/pain_4.png";
    } else if (_sliderValue >= 40 && _sliderValue < 50) {
      image = "assets/images/stress/pain_5.png";
    } else if (_sliderValue >= 50 && _sliderValue < 60) {
      image = "assets/images/stress/pain_6.png";
    } else if (_sliderValue >= 60 && _sliderValue < 70) {
      image = "assets/images/stress/pain_7.png";
    } else if (_sliderValue >= 70 && _sliderValue < 80) {
      image = "assets/images/stress/pain_8.png";
    } else if (_sliderValue >= 80 && _sliderValue < 90) {
      image = "assets/images/stress/pain_9.png";
    } else if (_sliderValue >= 90 && _sliderValue < 100) {
      image = "assets/images/stress/pain_10.png";
    } else {
      image = "assets/images/stress/pain_10.png";
    }
    return image;
